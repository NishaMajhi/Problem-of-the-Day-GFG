...
Your Task:
You don't need to read input or print anything. Your task is to complete the function sortedStrings() 
which takes an integer N and an array of strings A[ ] and 
returns the array in sorted order along with the frequency of each distinct string.
