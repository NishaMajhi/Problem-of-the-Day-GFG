/*
You are given an array arr of size n, containing the values in between 1 to n,
...
If from left, previous elments are diffrent it takes 1 Sec to pick & if element got repeated then it will take time[arr[i]].
