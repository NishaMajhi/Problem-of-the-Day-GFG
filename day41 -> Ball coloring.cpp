...
Your Task:  
You dont need to read input or print anything. Complete the function noOfWays() which takes n as input parameter and
returns  the number of ways in which balls can be colored.
