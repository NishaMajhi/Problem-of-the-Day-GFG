...
Your Task:  
You don't need to read input or print anything. Your task is to complete the function solve( ) which takes N and A[ ] as input parameters
and returns the position of the last modified bowl.
