/*
You are given two arrays A and B of equal length N. Your task is to pair each element of array A to an element in array B,
...
and returns the minimum sum of the absolute differences of the pairs.
