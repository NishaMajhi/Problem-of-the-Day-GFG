...
Your Task:
You don't need to read input or print anything. Your task is to complete the function waysToBreakNumber() which takes an integer N and 
returns the possible ways to break the number in 3 parts.
...
public:
    int waysToBreakNumber(int N){
        ...
        // 110/165 test cases pass
        // long long int mod = 1e9 + 7;
        // return ( (((N+1)%mod) * ((N+2)%mod)) /2);
